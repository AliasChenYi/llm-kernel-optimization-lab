...
@pytest.mark.parametrize("variant", ["default", "cache_weight", "two_pass", "two_pass_cache_weight"])
def test_rms_norm_triton_matches_reference(dtype, atol, rtol, shape, variant):
    ...
    actual = rms_norm_triton(x, weight, variant=variant)
